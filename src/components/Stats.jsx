    ...
    <section ref={sectionRef} className="py-32 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-24">
          <p className="text-[10px] font-extrabold uppercase tracking-[0.3em] text-gray-500">
            By the Numbers
          </p>
        ...
        <div className="flex justify-center gap-24">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                {/* ACCENT LINE */}
                <div className="h-16 w-[2px] bg-[#8BC34A] mb-6" />
             ...
             group-hover:scale-110"
                ...
                {/* LABEL */}
                <p className="mt-4 text-sm font-medium text-gray-600 max-w-[140px]">
                  {stat.label}
                </p>
              </div>
            );
